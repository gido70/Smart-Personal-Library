...
const checks = [
  ...
  [serviceWorker.includes("smart-personal-library-v0.10.5-cover-fast-7") && app.includes("spl-worker-prepared-v0105-cover-7") && !app.includes("spl-worker-prepared-v0103-3"), "devices discard the pre-fix PDF bundle"],
