...
const checks = [
  ...
  [serviceWorker.includes("smart-personal-library-v0.10.5-upload-3") && app.includes("spl-worker-prepared-v0105-upload-3") && !app.includes("spl-worker-prepared-v0103-3"), "devices discard the pre-fix PDF bundle"],
