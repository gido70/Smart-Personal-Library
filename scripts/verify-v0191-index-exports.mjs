...
const checks = [
  ...
  [serviceWorker.includes("spl-shell-offline-") && serviceWorker.includes("offline-assets.js") && !app.includes("spl-worker-prepared-v0105-cover-7"), "offline shell updates without erasing saved listening data"],
