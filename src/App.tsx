...
const text = {
  ar: {
    name: "المكتبة الشخصية الذكية", version: "نموذج GitHub التجريبي — V0.3",
  ...
  en: {
    name: "Smart Personal Library", version: "GitHub prototype — V0.3",
...
export default function Home() {
  ...
  return <div className={dark?"app dark":"app"} dir={rtl?"rtl":"ltr"} lang={lang}>
    <aside className="sidebar">
      ...
      <div className="prototype-note"><strong>{rtl?"مرحلة الاختبار V0.3":"Test milestone V0.3"}</strong><p>{rtl?"قارئ PDF المحلي يعمل الآن. التحليل والصوت ما زالا محاكاة موضحة.":"The local PDF reader now works. Analysis and audio remain labelled simulations."}</p></div>
